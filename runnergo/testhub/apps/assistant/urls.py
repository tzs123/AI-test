...
from .views import AssistantSessionViewSet, ChatViewSet, CopilotTaskViewSet, assistant_view
...
router.register(r'copilot', CopilotTaskViewSet, basename='assistant-copilot')
