        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "import_no",
                    models.CharField(
                        max_length=50, unique=True, verbose_name="导入编号"
                    ),
                ),
                (
                    "import_file",
                    models.FileField(
                        upload_to="testcase_imports/", verbose_name="导入文件"
                    ),
                ),
                (
                    "status",
                ...
                (
                    "failure_details",
                    models.JSONField(blank=True, default=list, verbose_name="失败明细"),
                ),
                (
                    "failure_report_file",
                    models.FileField(
                ...
                (
                    "template_version",
                    models.CharField(
                        default="v1", max_length=20, verbose_name="模板版本"
                    ),
                ),
                (
                    "celery_task_id",
